...
  return (
    // MODIFICARE 1: Folosim un singur container principal pentru scroll și logo
    <div className="min-h-screen flex flex-col p-6 overflow-auto 
                    lg:h-screen lg:items-center lg:justify-center">
      
      {/* MODIFICARE 2: Logo - Mutat în afara AnimatePresence, dar în fluxul principal */}
      <div 
        className="
...
      {/* AnimatePresence gestionează tranziția titlului */}
      <AnimatePresence mode="wait">
        {!showDetails ? (
          // Initial: Titlu mare centrat (folosim position: absolute pe mobil doar pentru asta)
          <motion.div
            key="title-only"
...
            className="w-full absolute inset-0 flex items-center justify-center z-50 lg:relative lg:p-0"
          >
...
      {/* Containerul de detalii - Vizibil doar după 1s */}
      {showDetails && (
        <motion.div
          key="full-details"
...
          className="w-full max-w-5xl space-y-6 lg:mt-0 mt-8" // Adaugă mt-8 pe mobil
        >
